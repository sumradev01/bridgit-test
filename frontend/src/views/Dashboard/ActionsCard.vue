...
const submitApplication = async () => {
  ...
  if (response.success) toast.success('Application Saved Successfully. ' + response.message)
  else {
...
<template>
  <div class="action-section">
    ...
    <BModal :visible="modal.isVisible.value" :confirm="modal.confirm">
      ...
      <form id="loan-form" @submit.prevent="submitApplication()">
      ...
      <template #footer>
        <BButton type="submit" form="loan-form" variant="primary" label="Submit"></BButton>
